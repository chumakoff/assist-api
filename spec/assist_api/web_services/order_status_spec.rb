...
describe AssistApi::WebServices::OrderStatus do
  before { set_config }
  after { clear_config }
  ...
  describe "#request_params" do
    ...
    subject { AssistApi::WebServices::OrderStatus.new(*params).request_params }
  ...
  describe "#result" do
    ...
    it_behaves_like "web service bad response", AssistApi::WebServices::OrderStatus
  ...
  describe "#original_response" do
    ...
    it_behaves_like "web service original response", AssistApi::WebServices::OrderStatus
  end
end
