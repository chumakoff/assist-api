...
describe AssistApi::WebServices::ConfirmOrder do
  before { set_config }
  after { clear_config }
  ...
  describe "#request_params" do
    ...
    subject { AssistApi::WebServices::ConfirmOrder.new(*params).request_params }
  ...
  describe "#result" do
    ...
    context "when successful response" do
      subject { AssistApi::WebServices::ConfirmOrder.new("ok", extra_params) }
    ...
    it_behaves_like "web service bad response", AssistApi::WebServices::ConfirmOrder
  end

  describe "#original_response" do
    before { stub_confirm_order_requests }

    it_behaves_like "web service original response", AssistApi::WebServices::ConfirmOrder
  end
end