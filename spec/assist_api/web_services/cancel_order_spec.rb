...
describe AssistApi::WebServices::CancelOrder do
  before { set_config }
  after { clear_config }
  ...
  describe "#request_params" do
    ...
    subject { AssistApi::WebServices::CancelOrder.new(*params).request_params }
  ...
  describe "#result" do
    ...
    context "when successful response" do
      subject { AssistApi::WebServices::CancelOrder.new("ok", extra_params) }
    ...
    it_behaves_like "web service bad response", AssistApi::WebServices::CancelOrder
  end

  describe "#original_response" do
    before { stub_cancel_order_requests }

    it_behaves_like "web service original response", AssistApi::WebServices::CancelOrder
  end
end